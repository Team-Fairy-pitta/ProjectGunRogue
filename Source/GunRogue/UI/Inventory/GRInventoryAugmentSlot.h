...
#include "GRInventoryAugmentSlot.generated.h"
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnInventoryAugmentSlotHovered, UGRInventoryAugmentSlot*, AugmentSlot);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnInventoryAugmentSlotUnhovered, UGRInventoryAugmentSlot*, AugmentSlot);


UCLASS()
class GUNROGUE_API UGRInventoryAugmentSlot : public UUserWidget
{
	GENERATED_BODY()

public:
	UPROPERTY(BlueprintAssignable)
	FOnInventoryAugmentSlotHovered OnInventoryAugmentSlotHovered;

	UPROPERTY(BlueprintAssignable)
	FOnInventoryAugmentSlotUnhovered OnInventoryAugmentSlotUnhovered;
