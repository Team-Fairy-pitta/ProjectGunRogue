...
void UGRGameplayAbility::GiveToAbilitySystem(UGRAbilitySystemComponent* ASC, FGRAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject) const
{
	check(ASC);
...
void UGRGameplayAbility::GrantAbilities(UGRAbilitySystemComponent* ASC, FGRAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject) const
{
...
void UGRGameplayAbility::GrantGameplayEffects(UGRAbilitySystemComponent* ASC, FGRAbilitySet_GrantedHandles* OutGrantedHandles) const
{
...
void UGRGameplayAbility::GrantAttributeSets(UGRAbilitySystemComponent* ASC, FGRAbilitySet_GrantedHandles* OutGrantedHandles) const
{
